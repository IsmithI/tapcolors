...
public class SinglePlayerRadioButton extends RadioButton {

    public SinglePlayerRadioButton(float x, float y) {
        ...
        addText(
            new Text.TextBuilder()
                    ...
                    .withText(Translator.getInstance().translate(Translator.Keys.SINGLE))
            .build()
        );
