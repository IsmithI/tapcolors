...
public class TwoPlayerRadioButton extends RadioButton {

    public TwoPlayerRadioButton(float x, float y) {
        ...
        addText(
                new Text.TextBuilder()
                        ...
                        .withText(Translator.getInstance().translate(Translator.Keys.TWO_PLAYERS))
                        .build()
        );
